...
$viewCart = array(
    "type"=> "Zend\Mvc\Router\Http\Segment",
    "options" => array(
        "route" => "/bookstore/user/cart.html",
        "defaults" => array(
            "__NAMESPACE__" => "Shop\Controller",
...
$history = array(
    "type"=> "Zend\Mvc\Router\Http\Segment",
    "options" => array(
        "route" => "/bookstore/user/history.html",
        "defaults" => array(
            "__NAMESPACE__" => "Shop\Controller",
            "controller"    => "Shop\Controller\User",
            "action"        => "history"
...
$category = array(
    'type' => 'Regex',
    'options' => array(
        'regex' => '/bookstore/category/(?<name>[a-zA-Z0-9_-]*)-(?<id>[0-9]*).(?<extension>(html|php))',
        'defaults' => array(
            '__NAMESPACE__' => 'Shop\Controller',
        ...
        'spec' => '/bookstore/category/%name%-%id%.%extension%',
    ),
    'may_terminate' => true,
    'child_routes' => array(
         'filter' => array(
...
$book = array(
    'type' => 'Regex',
    'options' => array(
        'regex' => '/bookstore/(?<category>[a-zA-Z0-9_-]*)/(?<name>[a-zA-Z0-9_-]*)/(?<id>[0-9]*).(?<extension>(html|php))',
        'defaults' => array(
            '__NAMESPACE__' => 'Shop\Controller',
